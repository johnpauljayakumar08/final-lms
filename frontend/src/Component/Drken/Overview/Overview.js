  ...
  return (
    <div className="container unique-story-container">
      ...
      <div className="row unique-story-content mt-4">
         <p>
         FINCATP offers a <b>comprehensive BFSI Sales Training program</b> designed to prepare candidates for successful careers in the <b>Banking, Financial Services, and Insurance sectors.</b> Our curriculum covers key areas such as<b> banking operations, financial products, investment services, and insurance fundamentals.</b>
         </p>
         <p>The course includes <b>role play, interactive sessions, case studies, and real-world applications</b> to ensure practical learning. The course is designed to help young individuals develop the skills they need to thrive in a range of job roles, from entry-level executives to mid-management cadre in any BFSI sector</p>
         <p>Our program is an empowering opportunity to gain the confidence and knowledge to succeed in the financial industry. Our program is ideal for those looking to venture into the BFSI industry.</p>
         <p>Enroll today and start your journey with us!</p>
